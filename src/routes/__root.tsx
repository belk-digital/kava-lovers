...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Love Kava | Premium Hemp & Kava Bar in Doral, FL" },
      { name: "description", content: "Discover Doral's premier wellness destination. Enjoy premium kava, CBD, and exotic snacks in a high-vibe atmosphere. Visit Hemp Love Farms today." },
      { name: "author", content: "Hemp Love Farms" },
      { name: "theme-color", content: "#1a3a2e" },
      { property: "og:url", content: "https://kava-lovers.vercel.app/" },
      { property: "og:title", content: "Love Kava | Premium Hemp & Kava Bar in Doral, FL" },
      { property: "og:description", content: "Discover Doral's premier wellness destination. Enjoy premium kava, CBD, and exotic snacks in a high-vibe atmosphere. Visit Hemp Love Farms today." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Love Kava" },
      { property: "og:locale", content: "en_US" },
      { property: "og:image", content: "https://kava-lovers.vercel.app/og-image.jpg" },
      { property: "og:image:secure_url", content: "https://kava-lovers.vercel.app/og-image.jpg" },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Premium Kava and Hemp Products at Love Kava Bar" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@hemplovefarms" },
      { name: "twitter:creator", content: "@hemplovefarms" },
      { name: "twitter:title", content: "Love Kava | Premium Hemp & Kava Bar in Doral, FL" },
      { name: "twitter:description", content: "Discover Doral's premier wellness destination. Enjoy premium kava, CBD, and exotic snacks in a high-vibe atmosphere. Visit Hemp Love Farms today." },
      { name: "twitter:image", content: "https://kava-lovers.vercel.app/og-image.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://kava-lovers.vercel.app/" },
